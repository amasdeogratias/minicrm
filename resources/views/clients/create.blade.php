                ...
                <a href="{{route('clients.index')}}" class="underline mb-">Clients</a>
                    <form method="POST" action="{{ route('clients.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="contact_phone_number" class="block mt-1 w-full" type="text" name="contact_phone_number" :value="old('contact_phone_number')" required autofocus autocomplete="name" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="company_zip" class="block mt-1 w-full" type="text" name="company_zip" :value="old('company_zip')" required autofocus autocomplete="name" />
