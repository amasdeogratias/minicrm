                ...
                <a href="{{route('projects.index')}}" class="underline mb-">All Projects</a>
                    <form method="POST" action="{{ route('projects.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500" name="description" required autofocus autocomplete="name">{{old('description')}}</textarea>
