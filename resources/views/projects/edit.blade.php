    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <a href="{{route('projects.index')}}" class="underline mb-">All Projects</a>
                    <form method="POST" action="{{ route('projects.update', $project) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500" name="description" required autofocus autocomplete="name">{{old('description', $project->description)}}</textarea>
